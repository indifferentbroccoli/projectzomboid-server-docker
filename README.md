...
| SERVER_WELCOME_MESSAGE                            | Welcome to the server!                                                                        | The first welcome message visible in the chat panel.                                                                                                |
...
| PUBLIC_NAME                                       | Project Zomboid                                                                               | Name of the server displayed in the in-game browser and, if applicable, the Steam browser                                                           |
| PUBLIC_DESCRIPTION                                | Project Zomboid Server                                                                        | Description displayed in the in-game public server browser. Typing \n will create a new line in your description                                    |
